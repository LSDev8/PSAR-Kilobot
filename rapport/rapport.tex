...
Il se d\'ecoupe en trois phases, la prem\`ere consiste en une recherche documentaire et une prise en main de la plate-forme mat\'erielle, la seconde concerne l'impl\'ementation d'algorithmes (dans notre cas de bio-algorithmes). Enfin la derni\`ere phase se concentre sur la recherche des possibilit\'es d'impl\'ementation d'un mod\`ele : le mod\`ele \textbf{CORDA}\footnote{\cite{CORDA} A New Distributed Model to Control and Coordinate a Set of Autonomous Mobile Robots: The Corda Model}.\\
...
\section*{Objectif}\label{sec:name}
