...
\begin{center}
\includegraphics[scale=0.7]{flashI.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{flashII.png}
\end{center}
...
%\subsection*{Chargement d'un nouveau firmware}\label{sec:name}
%\addcontentsline{toc}{subsection}{Chargement d'un nouveau firmware}

%\subsection*{Calibrage des kilobots}\label{sec:name}
%\addcontentsline{toc}{subsection}{Calibrage des kilobots}
