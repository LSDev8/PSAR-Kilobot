...
Cette API devra permettre la mise en place, sur la plate-forme Kilobot, d'un mod\`ele que nous nommerons \textbf{mod\`ele A}.
...
\medskip
Ces contraintes posent plusieurs probl\`ematiques.\\
...
Nous d\'etaillerons les possibilit\'ees des kilobots dans un prochain chapitre.\\
...
La phase II demandant plus de r\'eflexion, nous m\^imes nos comp\'etences acquises \`a la premi\`ere phase en comment afin de proposer un bio-algorithme digne d'int\'er\^et.\\
